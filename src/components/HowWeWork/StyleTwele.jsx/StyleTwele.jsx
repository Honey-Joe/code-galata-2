  ...
  return (
    <>
        <div className=" w-[90%] lg:w-[90%] mx-auto lg:py-[40px] py-[20px]">
            <div>
                <h1 className=" text-start py-5 font-[poppins] font-bold text-[24px] md:text-[34px] text-[#192335]">How we <span className="text-[#1176F0] underline underline-offset-4">Work!</span> </h1>
