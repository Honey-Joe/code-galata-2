  ...
  return (
    <>
        <div className=" w-[90%] lg:w-[90%] mx-auto">
            <div>
                <h1 className=" text-start py-14 font-[poppins] font-bold text-[30px] text-[#192335]">How we <span className="text-[#1176F0] underline underline-offset-4">Work!</span> </h1>
