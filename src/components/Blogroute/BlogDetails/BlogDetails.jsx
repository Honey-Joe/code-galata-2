                ...
                <div className=" grid grid-cols-1 lg:grid-cols-3 gap-5 lg:gap-16">
                    <div className=" py-5 lg:py-10 col-span-2 md:col-span-2">
                        ...
                        <div className=" bg-[#F1F8FF] border-l-[6px] border-[#1176F0] my-10"> 
                            <h1 className=" md:py-12 md:px-12 px-8 py-8 lg:pr-40 text-lg md:text-xl text-[#1176F0] font-bold">“ urabitur varius eros rutrum consequat Mauris sollicitudin enim condimentum luctus enim justo non molestie nisl ”</h1>
                        </div>
                        <DuringThisProgram/>
                        <Blogform></Blogform>
                    </div>
