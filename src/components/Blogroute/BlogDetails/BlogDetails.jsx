                ...
                <div className=" grid grid-cols-1 lg:grid-cols-3 gap-5 lg:gap-16">
                    <div className=" py-5 lg:py-10 col-span-2 md:col-span-2">
                        ...
                        <div className=" flex gap-5 items-center py-5">
                            ...
                            <div className="flex items-center gap-2">
                                <CalendarDays className=" stroke-1 w-5 stroke-[#1176F0]"/>
                                <p className=" font-[poppins] text-sm text-[#39557e]">June 22, 2023</p>
                            </div>
                            <div className="flex items-center gap-2">
                                <MessageCircle className=" stroke-1 w-5 stroke-[#1176F0]"/>
                        ...
                        <div className=" bg-[#F1F8FF] border-l-[6px] border-[#1176F0] my-10"> 
                            <h1 className=" md:py-12 md:px-12 px-8 py-8 lg:pr-40 text-lg md:text-xl text-[#1176F0] font-bold font-[poppins]">“ urabitur varius eros rutrum consequat Mauris sollicitudin enim condimentum luctus enim justo non molestie nisl ”</h1>
                        </div>
                        <DuringThisProgram/>
                        <Blogform></Blogform>
                    </div>
