        ...
        <div>
            <div className="px-6 py-8">
                ...
                <div className=" pt-5 group">
                    ...
                    <div  className={`grid overflow-hidden transition-all  rounded-b-md duration-300 ease-in-out  text-sm border-2 ${
                        ...
                        <div className="p-3 flex items-center justify-between hover:bg-[#e3e5eb]">
                            <div className=" flex items-center gap-2">
                                <Youtube className="font-bold h-5 text-slate-600"/>
                                <p className=" font-medium text-[16px] hover:bg-[#ebecef] font-[poppins] text-slate-800">Demands</p>
                            </div>
                            <div className=" flex space-x-3">
                                <p className=" font-[poppins] text-[14px] text-slate-600">07:00</p>
                                <LockKeyhole className=" h-4 text-slate-600"/>
                ...
                <div className=" pt-0 group">
                    <button  onClick={()=> setBasic(!basic)} className={`flex items-center justify-between w-full  p-3 rounded-md border-2  ${basic ? 'rounded-bl-none rounded-br-none text-[#1176F0] bg-[#e3e5eb] '  : 'rounded-md'}`}>
                        <span className=" font-medium font-[poppins] text-[18px] transition-colors ease-in-out group-hover:text-[#1176F0]">Sketching</span>
                ...
                <br />
                <div className=" pt-0 group">
                    <button  onClick={()=> setBasic2(!basic2)} className={`flex items-center justify-between w-full  p-3 rounded-md border-2  ${basic2 ? 'rounded-bl-none rounded-br-none text-[#1176F0] bg-[#e3e5eb] '  : 'rounded-md'}`}>
                        <span className=" font-medium font-[poppins] text-[18px] transition-colors ease-in-out group-hover:text-[#1176F0]">Figma Basics</span>
                ...
                <br />
                <div className=" pt-0 group">
                    <button  onClick={()=> setBasic3(!basic3)} className={`flex items-center justify-between w-full  p-3 rounded-md border-2  ${basic3 ? 'rounded-bl-none rounded-br-none text-[#1176F0] bg-[#e3e5eb] '  : 'rounded-md'}`}>
                        <span className=" font-medium font-[poppins] text-[18px] transition-colors ease-in-out group-hover:text-[#1176F0]">Figma Tool</span>
                        
                        <span><ChevronRight className={`${basic3? '-rotate-90 transition stroke-[#1176F0]' : ' rotate-0 transition stroke-[#1176F0]'}`}/></span>
                    </button>
