    ...
    <div className=" max-w-[100%] mx-auto pt-36">
        <div className=" w-[90%] mx-auto">
            <div className="text-center mb-10 space-y-4">
                ...
                Working Process For <span className="text-[#1176F0]">Technology</span>
                </h2>
            </div>
            <div className="flex flex-col lg:flex-row justify-between items-center lg:items-center gap-10">
                <div className="flex flex-col items-center text-center">
                
                <div className=" border-gray-200 rounded-full p-5 border-2 hover:border-[#1176F0] hover:border-dashed"><img
